...
class TestCase(unittest.TestCase):
    ...
    def test_config_knowledge_person(self):
        try:
            ...
            actions = ActionChains(self.driver).move_to_element(
                self.driver.find_element(By.XPATH, '//div[@class = "el-submenu__title" and text() =" 新建知识 " ]'))
            actions.perform()
            time.sleep(1)
            knowledgeMenuList = self.driver.find_elements(By.XPATH,
                                                          '//li[contains(@class, "el-menu-item-group") and contains(@class, "workbench-submenu-vertical")]')
            knowledgeMenuList[1].find_elements(By.TAG_NAME, 'li')[0].click()
            time.sleep(2)
    ...
    def test_config_knowledge_event(self):
        try:
            ...
            knowledgeMenuList = self.driver.find_elements(By.XPATH,
                                                          '//li[contains(@class, "el-menu-item-group") and contains(@class, "workbench-submenu-vertical")]')
            knowledgeMenuList[1].find_elements(By.TAG_NAME, 'li')[1].click()
            time.sleep(2)
            knowledge = self.driver.find_elements(By.XPATH, '//div[@class="workbench-content"]')[2]
            formContainerList = knowledge.find_elements(By.CLASS_NAME, 'form-container')
    ...
    def test_config_knowledge_subject(self):
        try:
            ...
            knowledgeMenuList = self.driver.find_elements(By.XPATH,
                                                          '//li[contains(@class, "el-menu-item-group") and contains(@class, "workbench-submenu-vertical")]')
            knowledgeMenuList[1].find_elements(By.TAG_NAME, 'li')[2].click()
            time.sleep(2)
            knowledge = self.driver.find_elements(By.XPATH, '//div[@class="workbench-content"]')[2]
            formContainerList = knowledge.find_elements(By.CLASS_NAME, 'form-container')
    ...
    def test_config_knowledge_organization(self):
        try:
            ...
            knowledgeMenuList = self.driver.find_elements(By.XPATH,
                                                          '//li[contains(@class, "el-menu-item-group") and contains(@class, "workbench-submenu-vertical")]')
            knowledgeMenuList[1].find_elements(By.TAG_NAME, 'li')[3].click()
            time.sleep(2)
            knowledge = self.driver.find_elements(By.XPATH, '//div[@class="workbench-content"]')[2]
            formContainerList = knowledge.find_elements(By.CLASS_NAME, 'form-container')
    ...
    def test_config_knowledge_geography(self):
        try:
            ...
            knowledgeMenuList = self.driver.find_elements(By.XPATH,
                                                          '//li[contains(@class, "el-menu-item-group") and contains(@class, "workbench-submenu-vertical")]')
            knowledgeMenuList[1].find_elements(By.TAG_NAME, 'li')[4].click()
            time.sleep(2)
            knowledge = self.driver.find_elements(By.XPATH, '//div[@class="workbench-content"]')[2]
            formContainerList = knowledge.find_elements(By.CLASS_NAME, 'form-container')
